...
public class ItemGirdAdapter extends ArrayAdapter {
    String[] nama;
    String[] gejala;
    String[] solusi;
    String[] desk;
    ...
    public ItemGirdAdapter(Activity context, String[] nama, String[] desk, String[] solusi, String[] gejala, String[] images) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View viewRow = layoutInflater.inflate(R.layout.gird_item, null,
                true);
